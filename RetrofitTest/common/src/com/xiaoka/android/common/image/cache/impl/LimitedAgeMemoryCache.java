 ...
 *******************************************************************************/
package com.xiaoka.android.common.image.cache.impl;

import android.graphics.Bitmap;

import com.xiaoka.android.common.image.cache.MemoryCache;
...
/**
 * Decorator for {@link com.xiaoka.android.common.image.cache.MemoryCache}. Provides special feature for cache: if some cached object age exceeds defined
 * value then this object will be removed from cache.
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @see com.xiaoka.android.common.image.cache.MemoryCache
 * @since 1.3.1
 */
