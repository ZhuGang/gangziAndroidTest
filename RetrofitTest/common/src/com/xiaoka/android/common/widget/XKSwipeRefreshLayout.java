 ...
 */
@SuppressLint("NewApi")
public class XKSwipeRefreshLayout extends ViewGroup {
	// Maps to ProgressBar.Large style
	public static final int LARGE = MaterialProgressDrawable.LARGE;
	// Maps to ProgressBar default style
	public static final int DEFAULT = MaterialProgressDrawable.DEFAULT;

	private static final String LOG_TAG = XKSwipeRefreshLayout.class
			.getSimpleName();
	...
	private static final int CIRCLE_DIAMETER_LARGE = 56; // 56
	...
	// spinner should stop
	private static final int DEFAULT_CIRCLE_TARGET = 50;// 64
...
//	private boolean mNotify;
	 ...
	 * @param context
	 */
	public XKSwipeRefreshLayout(Context context) {
		this(context, null);
	}
